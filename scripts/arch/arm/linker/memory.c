...
int main(int argc, char **argv){
	...
	r = 0;
	r |= overlap("kernel flash", CONFIG_ARM_KERNEL_TEXT_BASE, CONFIG_ARM_KERNEL_TEXT_SIZE,
				 "application flash", CONFIG_ARM_APP_TEXT_BASE, CONFIG_ARM_APP_TEXT_SIZE
	);

	r |= overlap("kernel data", CONFIG_ARM_KERNEL_DATA_BASE, CONFIG_ARM_KERNEL_DATA_SIZE,
				 "application data", CONFIG_ARM_APP_DATA_BASE, CONFIG_ARM_APP_DATA_SIZE
	);
	...
	fprintf(ofile, "%20s : ORIGIN = %#10x, LENGTH = %u\n", "flash_kernel", CONFIG_ARM_KERNEL_TEXT_BASE, CONFIG_ARM_KERNEL_TEXT_SIZE);
	fprintf(ofile, "%20s : ORIGIN = %#10x, LENGTH = %u\n", "flash_app", CONFIG_ARM_APP_TEXT_BASE, CONFIG_ARM_APP_TEXT_SIZE);
	fprintf(ofile, "%20s : ORIGIN = %#10x, LENGTH = %u\n", "data_kernel", CONFIG_ARM_KERNEL_DATA_BASE, CONFIG_ARM_KERNEL_DATA_SIZE);
	fprintf(ofile, "%20s : ORIGIN = %#10x, LENGTH = %u\n", "data_app", CONFIG_ARM_APP_DATA_BASE, CONFIG_ARM_APP_DATA_SIZE);
	fprintf(ofile, "}\n");
