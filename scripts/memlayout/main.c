...
int main(){
	...
	PRINT_RANGE("kernel flash", CONFIG_AVR_KERNEL_TEXT_BASE, CONFIG_AVR_KERNEL_TEXT_SIZE);
	PRINT_RANGE("kernel data", CONFIG_AVR_KERNEL_DATA_BASE, CONFIG_AVR_KERNEL_DATA_SIZE);
	PRINT_RANGE("application flash", CONFIG_AVR_APP_TEXT_BASE, CONFIG_AVR_APP_TEXT_SIZE);
	PRINT_RANGE("application data", CONFIG_AVR_APP_DATA_BASE, CONFIG_AVR_APP_DATA_SIZE);
	PRINT_RANGE("mapped register", CONFIG_AVR_MREG_BASE, CONFIG_AVR_MREG_SIZE);
#endif // CONFIG_AVR

#ifdef CONFIG_ARM
	PRINT_HEAD("arm specific");

	PRINT_RANGE("kernel flash", CONFIG_ARM_KERNEL_TEXT_BASE, CONFIG_ARM_KERNEL_TEXT_SIZE);
	PRINT_RANGE("kernel data", CONFIG_ARM_KERNEL_DATA_BASE, CONFIG_ARM_KERNEL_DATA_SIZE);
	PRINT_RANGE("application flash", CONFIG_ARM_APP_TEXT_BASE, CONFIG_ARM_APP_TEXT_SIZE);
	PRINT_RANGE("application data", CONFIG_ARM_APP_DATA_BASE, CONFIG_ARM_APP_DATA_SIZE);
#endif // CONFIG_ARM
	printf("\n");
