...
// 		exceptions, espcially svcall, to allow svc being issued from within an
...
int av6m_core_init(uint32_t clock_mhz){
	SCR = (0x0 << SCR_SEVONPEND)
		| (0x1 << SCR_SLEEPDEEP)
		| (0x0 << SCR_SLEEPONEXIT)
		;

	SHPR2 = (SVCALL_PRIO << SHPR2_PRI11);
	SHPR3 = (SYSTICK_PRIO << SHPR3_PRI15)
		  | (PENDSV_PRIO << SHPR3_PRI14)
		  ;
