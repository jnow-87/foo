...
// registers
#define ICSR			MREG(AV6M_PPB_BASE | 0xed04)
#define VTOR			MREG(AV6M_PPB_BASE | 0xed08)

#define SCR				MREG(AV6M_PPB_BASE | 0xed10)

#define SHPR2			MREG(AV6M_PPB_BASE | 0xed1c)
#define SHPR3			MREG(AV6M_PPB_BASE | 0xed20)
