...
#define copy_from_user(tgt, src, size, p)	(arch_kernel_call(copy_from_user, 0)(tgt, src, size, p))
#define copy_to_user(tgt, src, size, p)		(arch_kernel_call(copy_to_user, 0)(tgt, src, size, p))
